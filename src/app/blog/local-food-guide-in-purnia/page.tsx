...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://hotelsuryabellacasa.com/blog/local-food-guide-in-purnia' },
  openGraph: {
  title: 'Local Food Guide in Purnea | Must-Try Dishes',
    description: 'Explore Purnea food scene. Litti Chokha, Thekua, Mitha Khana, and local Bihari cuisine. Best restaurants near Hotel Surya Bella Casa.',
    url: 'https://hotelsuryabellacasa.com/blog/local-food-guide-in-purnia',
...
export default function BlogPost() {
  ...
  return (
    <BlogArticleLayout
      ...
      relatedArticles={[
        { title: 'Best Restaurants in Purnia', link: '/blog/best-restaurant-in-purnia' },
    ...
    >
      <p>
        Purnia&apos;s food scene is a hidden gem waiting to be discovered. From rustic roadside stalls serving <strong>Litti Chokha</strong> to elegant rooftop restaurants offering multi-cuisine menus, the city caters to every palate. Whether you&apos;re a die-hard fan of <strong>authentic Bihari cuisine</strong> or someone who enjoys international flavors, this local food guide will help you navigate the best eats in Purnia. And if you&apos;re staying at <Link href="/" className="text-gold hover:underline">Hotel Surya Bella Casa</Link>, you&apos;re perfectly positioned to explore it all.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Must-Try Bihari Dishes in Purnia</h2>
      <p>
        <strong>Litti Chokha</strong> is the undisputed king of Bihari cuisine, and Purnia serves some of the best versions in the state. The dish consists of roasted wheat balls (litti) stuffed with a spiced gram flour (sattu) mixture, served alongside chokha — a smoky mash of roasted eggplant, tomatoes, and potatoes seasoned with mustard oil, garlic, and green chilies. You&apos;ll find the best Litti Chokha at small stalls near <Link href="/blog/shopping-in-purnia" className="text-gold hover:underline">Vikass Market</Link> and the bus stand area, where vendors cook them over open coal fires.
      </p>
      <p>
        <strong>Thekua</strong> is a traditional sweet cookie made from wheat flour, jaggery (or sugar), and ghee. While it&apos;s traditionally prepared during the <strong>Chhath Puja</strong> festival, many sweet shops in Purnea make it year-round. The crunchy, mildly sweet flavor pairs perfectly with a cup of masala chai. Look for it at the local sweet shops in <strong>Bhatta Bazar</strong>, one of Purnia&apos;s oldest commercial districts.
      </p>
      <p>
        <strong>Mitha Khana</strong> (sweet fox nuts) is a Purnia specialty that you won&apos;t easily find elsewhere in India. Made from fox nuts (makhana) roasted in ghee and coated with sugar syrup, it&apos;s a light, crunchy snack that doubles as a dessert. It&apos;s commonly served during festive occasions but is available at sweet shops throughout the year.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Street Food Trail: Where to Eat</h2>
      <p>
        Purnia&apos;s street food scene comes alive in the evenings, particularly around the <Link href="/blog/best-hotels-in-purnea-near-bus-stand" className="text-gold hover:underline">Bus Stand area</Link>. Here are the must-visit spots:
      </p>
