...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://hotelsuryabellacasa.com/blog/shopping-in-purnia' },
  openGraph: {
    title: 'Shopping in Purnea | Best Markets, Malls & Local Bazaars',
  description: 'Guide to shopping in Purnea. Vikass Market, Bhatta Bazar, City Mall, and local bazaars for fabrics and street shopping near Hotel Surya Bella Casa.',
    url: 'https://hotelsuryabellacasa.com/blog/shopping-in-purnia',
...
export default function BlogPost() {
  ...
  return (
    ...
    >
      <p>
        Shopping in Purnia is an experience that blends traditional Bihari bazaar culture with modern retail options. Whether you&apos;re looking for <strong>handwoven fabrics</strong>, <strong>local sweets</strong>, <strong>electronics</strong>, or <strong>Madhubani art</strong>, the city&apos;s markets have something for every type of shopper. The best part? Most of Purnia&apos;s major markets are clustered around the Bus Stand area, making <Link href="/" className="text-gold hover:underline">Hotel Surya Bella Casa</Link> the perfect base for a shopping spree.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Vikass Market: Purnia&apos;s Commercial Heart</h2>
      <p>
        <strong>Vikass Market</strong> is the largest and busiest market in Purnia, located directly opposite <Link href="/" className="text-gold hover:underline">Hotel Surya Bella Casa</Link>. This sprawling commercial complex houses hundreds of shops selling everything from garments and fabrics to electronics, mobile phones, and household goods. The market is a two-minute walk from the hotel, making it incredibly convenient for guests who want to shop without traveling far.
      </p>
      <p>
