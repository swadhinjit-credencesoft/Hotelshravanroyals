...
export const metadata: Metadata = {
  title: 'Purnea Travel Guide | How to Reach, Where to Stay & What to Eat',
  description: 'Complete Purnea travel guide. How to reach by train, bus, and flight. Best areas to stay, food to try, and top attractions near Hotel Surya Bella Casa.',
  keywords: ['Purnea travel guide', 'how to reach Purnea', 'Purnea bihar travel', 'visit Purnea bihar'],
  alternates: { canonical: 'https://hotelsuryabellacasa.com/blog/Purnea-travel-guide' },
  openGraph: {
  title: 'Purnea Travel Guide | How to Reach & Where to Stay',
    description: 'Complete Purnea travel guide. How to reach by train, bus, and flight. Best areas to stay, food to try, and top attractions near Hotel Surya Bella Casa.',
    url: 'https://hotelsuryabellacasa.com/blog/Purnea-travel-guide',
  ...
  twitter: {
    ...
    title: 'Purnea Travel Guide | How to Reach, Stay & Eat',
    description: 'Complete Purnea travel guide covering how to reach, best areas to stay, food to try, and top attractions near Hotel Surya Bella Casa.',
...
export default function BlogPost() {
  const schema = {
    ...
    "@type": "BlogPosting",
    "headline": "Purnea Travel Guide | How to Reach, Where to Stay & What to Eat",
    "description": "Complete Purnea travel guide. How to reach by train, bus, and flight. Best areas to stay, food to try, and top attractions near Hotel Surya Bella Casa.",
  ...
  return (
    ...
    >
      <p>
        Planning a trip to <strong>Purnea</strong> (also spelled Purnea)? Located in the Seemanchal region of Bihar, Purnea is one of the most commercially important cities in eastern Bihar. Whether you&apos;re traveling for business, pilgrimage, or leisure, this <strong>Purnea travel guide</strong> covers everything you need to know — from how to reach the city to where to stay, what to eat, and which attractions to explore. And if you&apos;re looking for a comfortable base, <Link href="/" className="text-gold hover:underline">Hotel Surya Bella Casa</Link> near the Bus Stand is the ideal choice.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">How to Reach Purnea</h2>
      <p>
        <strong>By Train:</strong> The nearest major railway station is <strong>Purnea Junction</strong> (station code: PRNA), located about 6.1 km from the city center. Regular trains connect Purnea to Katihar, Bhagalpur, Saharsa, Delhi, and other major cities. From the railway station, auto-rickshaws and taxis are readily available to take you to <Link href="/blog/best-hotels-in-purnea-near-bus-stand" className="text-gold hover:underline">hotels near the Bus Stand</Link> area. The journey from the station to <Link href="/" className="text-gold hover:underline">Hotel Surya Bella Casa</Link> takes approximately 15 minutes by auto.
      </p>
      <p>
        <strong>By Bus:</strong> Purnea Bus Stand is the main intercity bus terminal, with frequent services to and from Patna, Katihar, Saharsa, Forbesganj, and other towns in Bihar. The bus stand area, particularly around <strong>Vikass Market</strong>, is the commercial heart of the city. If you arrive by bus, <Link href="/how-to-reach" className="text-gold hover:underline">Hotel Surya Bella Casa</Link> is just a 2-minute walk from the terminal — making it the most convenient option for bus travelers.
      </p>
      <p>
        <strong>By Air:</strong> The nearest airport is <strong>Biratnagar Airport</strong> in Nepal (about 100 km) or <strong>Bagdogra Airport</strong> in West Bengal (about 250 km). From Bagdogra, you can hire a private cab or take a shared taxi to Purnea, which takes approximately 5-6 hours. For domestic flights, Patna Airport (Lok Nayak Jayaprakash Airport) is about 320 km away and offers more frequent connections. From Patna, you can take a train or bus to Purnea.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Best Areas to Stay in Purnea</h2>
      <p>
      ...
      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">What to Eat in Purnea</h2>
      <p>
        Purnea is a food lover&apos;s paradise, especially for those who enjoy authentic Bihari cuisine. <strong>Litti Chokha</strong> is the signature dish — roasted wheat balls stuffed with spiced sattu, served with mashed potato and brinjal chokha. <strong>Thekua</strong>, a traditional sweet cookie, and <strong>Mitha Khana</strong>, a sweetened fox nut preparation, are local specialties you must try.
      </p>
      <p>
        For a more refined dining experience, <Link href="/dining" className="text-gold hover:underline">Hotel Surya Bella Casa&apos;s rooftop restaurant</Link> serves a multi-cuisine menu including Indian, Tandoor, Mughlai, Asian, and Continental dishes. The hotel also coordinates with top-rated local restaurants via Swiggy and Zomato for doorstep delivery of non-vegetarian dishes. For a complete rundown of local food options, check our <Link href="/blog/local-food-guide-in-Purnea" className="text-gold hover:underline">local food guide</Link>.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Top Attractions & Things to Do</h2>
      <p>
        Purnea offers a range of attractions for different types of travelers. Spiritual seekers should visit <strong>Maa Puran Devi Temple</strong> and <strong>Kali Mandir</strong>, both within easy reach of the hotel. History enthusiasts will appreciate <strong>Jalalgarh Fort</strong>, a 300-year-old structure showcasing blended Hindu and Islamic architecture. Shoppers will love <Link href="/blog/shopping-in-Purnea" className="text-gold hover:underline">Vikass Market</Link> and <strong>Bhatta Bazar</strong>, where you can find everything from fabrics to electronics.
      </p>
      <p>
        For a full list of attractions, read our <Link href="/blog/places-to-visit-in-purnea" className="text-gold hover:underline">places to visit in Purnea</Link> guide. If you have more time, consider day trips to <strong>Kishanganj</strong> (tea gardens), <strong>Araria</strong> (rural landscapes), or the Mahananda River area. Our <Link href="/blog/things-to-do-in-Purnea" className="text-gold hover:underline">things to do guide</Link> has detailed itineraries for weekend activities.
      </p>

      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Local Transport in Purnea</h2>
      <p>
        Getting around Purnea is easy and affordable. <strong>Auto-rickshaws</strong> are the most common mode of transport and are available everywhere — from the bus stand to the railway station and all major localities. For longer distances within the city, you can also use <strong>e-rickshaws</strong> (toto), which are cheaper and eco-friendly. Private taxis and rental cars can be arranged through local operators or apps for day trips to nearby attractions.
      </p>
      <p>
      ...
      <h2 className="font-display text-2xl italic text-forest mt-10 mb-4">Quick Travel Tips for Purnea</h2>
      <p>
