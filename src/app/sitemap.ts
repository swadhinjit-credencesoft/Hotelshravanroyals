...
const blogArticles = [
  ...
  'hotels-near-purnia-railway-station',
  'best-restaurant-in-purnia',
  'fine-dining-restaurant-in-purnia',
  'family-restaurant-in-purnia',
  'best-dinner-place-in-purnia',
  'wedding-venue-in-purnia',
  'birthday-party-venue-in-purnia',
  'corporate-event-venue-in-purnia',
  'things-to-do-in-purnia',
  'purnia-travel-guide',
  'local-food-guide-in-purnia',
  'shopping-in-purnia',
...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  ...blogArticles.map(slug => {
    const imageMap: Record<string, string[]> = {
      ...
      'luxury-hotel-in-purnia': ['https://bookonelocal.in/cdn/IMG_3808.avif'],
      'hotels-near-purnia-railway-station': ['https://bookonelocal.in/cdn/IMG_3791.avif'],
      'best-restaurant-in-purnia': ['https://bookonelocal.in/cdn/IMG_3808.avif'],
      'fine-dining-restaurant-in-purnia': ['https://bookonelocal.in/cdn/IMG_3784.avif'],
      'family-restaurant-in-purnia': ['https://bookonelocal.in/cdn/IMG_3701.avif'],
      'best-dinner-place-in-purnia': ['https://bookonelocal.in/cdn/IMG_3766.avif'],
      'wedding-venue-in-purnia': ['https://bookonelocal.in/cdn/IMG_3764.avif'],
      'birthday-party-venue-in-purnia': ['https://bookonelocal.in/cdn/IMG_3709.jpeg'],
      'corporate-event-venue-in-purnia': ['https://bookonelocal.in/cdn/IMG_3703.avif'],
      'things-to-do-in-purnia': ['https://bookonelocal.in/cdn/IMG_3809.avif'],
      'purnia-travel-guide': ['https://bookonelocal.in/cdn/IMG_3815.avif'],
      'local-food-guide-in-purnia': ['https://bookonelocal.in/cdn/IMG_3739.avif'],
      'shopping-in-purnia': ['https://bookonelocal.in/cdn/IMG_3809.avif'],
